...
这一系列的文章会带领你开发一个简单的划词翻译扩展程序。“从零开始”意味着你不需要有开发扩展程序的经验也能阅读，但是，这一系列的文章并不是一个纯粹的教程，我会在文章中着重介绍我开发划词翻译时实际遇到的问题以及解决方案，并由浅至深的介绍涉及到扩展程序方面的内容。

我希望这一系列的文章，对于无论是否有过开发扩展程序的经验的读者都有所益处：

- 没有扩展程序开发经验的读者，可以通过实际开发一个扩展程序逐渐了解扩展程序的方方面面
- 有扩展程序开发经验的读者，也可以在这个过程中了解我在开发划词翻译时遇到的各种问题与解决方案
